...
// By Ingemar Ragnemalm, based on the hello.c demo (which was NOT Hello World in
// any way).

// gcc hello_world_cl.c -o hello_world_cl CLutilities.c -lOpenCL
...
int main(int argc, char **argv) {
  ...
  // Create space for data and copy a and b to device (note that we could also
  // use clEnqueueWriteBuffer to upload)
